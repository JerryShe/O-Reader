...
public:
    ...
    {
        BookTableOfContents->setWindowTitle(QApplication::translate("BookTableOfContents", "Dialog", Q_NULLPTR));
        Close->setText(QApplication::translate("BookTableOfContents", "Close", Q_NULLPTR));
        GoTo->setText(QApplication::translate("BookTableOfContents", "Go to the selected", Q_NULLPTR));
    } // retranslateUi
