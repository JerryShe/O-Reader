...
public:
    ...
    void setupUi(QWidget *LibraryLayout)
    {
        ...
        ShowButton = new QPushButton(LibraryLayout);
        ...
        ShowButton->setMinimumSize(QSize(15, 0));
        ShowButton->setMaximumSize(QSize(15, 16777215));
        ShowButton->setCheckable(true);

        horizontalLayout->addWidget(ShowButton);

        LibraryView = new Library(LibraryLayout);
        LibraryView->setObjectName(QStringLiteral("LibraryView"));

        horizontalLayout->addWidget(LibraryView);
