...
public:
    ...
    {
        Settings_ProfileLayout->setWindowTitle(QApplication::translate("Settings_ProfileLayout", "Frame", Q_NULLPTR));
        label_2->setText(QApplication::translate("Settings_ProfileLayout", "Change password", Q_NULLPTR));
        ChangePasswordButton->setText(QApplication::translate("Settings_ProfileLayout", "Change", Q_NULLPTR));
        SaveButton->setText(QApplication::translate("Settings_ProfileLayout", "Save settings", Q_NULLPTR));
    } // retranslateUi
