...
{
    static SettingsHandler ProgramSettings;
    return &ProgramSettings;
}


void SettingsHandler::setTranslator(QTranslator* translator)
{
    LanguageTranslator = translator;
}


QString SettingsHandler::getTextAlignName(const unsigned short &key) const
{
...
QJsonObject SettingsHandler::toJson() const
{
    QJsonObject json;
...
void SettingsHandler::fromJson(const QJsonObject &json)
{
...
QString TextStyleSheet::getHTMLStyle(const int &scale) const
{
    QString tempHTML =
                       ...
                       "text-align:" + SettingsHandler::getSettings()->getTextAlignName(Align) + ";"
                       "color:" + Color + ";";
...
QString SettingsHandler::getInterfaceStyle()
{
    return InterfaceStyle;
}


void SettingsHandler::setInterfaceStyle(const QString &style)
{
    InterfaceStyle = style;
}


QString SettingsHandler::getCurrentLanguage() const
{
    return Language;
}


void SettingsHandler::setLanguage(const QString &lang)
{
    Language = lang;
    bool done = false;
    if (lang == "Русский")
...
bool SettingsHandler::getHideTopBar() const
{
    return HideTopBar;
}


void SettingsHandler::setHideTopBar(const bool &n)
{
    HideTopBar = n;
}


QString SettingsHandler::getCurrentReadProfileName() const
{
    return currentStyle;
}


void SettingsHandler::setCurrentReadProfile(const QString &style)
{
    currentStyle = style;
}


QStringList SettingsHandler::getReadProfilesList() const
{
    return TextStylesNames;
}


int SettingsHandler::getFForwardKey() const
{
    return FKeyForwardPage;
}


void SettingsHandler::setFForwardKey(const int &key)
{
    FKeyForwardPage = key;
}


int SettingsHandler::getSForwardKey() const
{
    return SKeyForwardPage;
}


void SettingsHandler::setSForwardKey(const int &key)
{
    SKeyForwardPage = key;
}


int SettingsHandler::getFBackwardKey() const
{
    return FKeyBackwardPage;
}


void SettingsHandler::setFBackwardKey(const int &key)
{
    FKeyBackwardPage = key;
}


int SettingsHandler::getSBackwardKey() const
{
    return SKeyBackwardPage;
}


void SettingsHandler::setSBackwardKey(const int &key)
{
    SKeyBackwardPage = key;
}


bool SettingsHandler::getTurnByWheel() const
{
    return PageTurnByWheel;
}


void SettingsHandler::setTurnByWheel(const bool &turn)
{
    PageTurnByWheel = turn;
}


bool SettingsHandler::getTurnByTap() const
{
    return PageTurnByTap;
}


void SettingsHandler::setTurnByTap(const bool &turn)
{
    PageTurnByTap = turn;
}


ReadingProfile SettingsHandler::getNamedReadProfile(const QString name) const
{
...
ReadingProfile SettingsHandler::getCurrentReadProfile() const
{
    return TextStyles.at(TextStylesNames.indexOf(currentStyle));
}


void SettingsHandler::saveReadProfile(const QString &name, const ReadingProfile &style)
{
...
void SettingsHandler::removeNamedReadProfile(const QString &name)
{
    int index = TextStylesNames.indexOf(name);
    if (index != -1)
    {
