#include "reading_window/widgets/right_click_menu.h"
#include "ui_right_click_menu.h"

#include <QDebug>


void RightClickMenu::setStyle()
{
...
void RightClickMenu::setState(const int &state)
{
    ui->Note->hide();
