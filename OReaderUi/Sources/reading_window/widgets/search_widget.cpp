...
#include "styles.h"
#include "search_results_delegate.h"
...
{
    QString styles[2];
    setExitButtonStyle(styles, SettingsHandler::getSettings()->getInterfaceStyle());
...

{
    ...
    SearchResultsDelegate *delegate = new SearchResultsDelegate(this);
